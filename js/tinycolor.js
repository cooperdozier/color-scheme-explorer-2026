// Lines 5-1192 are from https://github.com/bgrins/TinyColor/blob/master/npm/cjs/tinycolor.js
// Homepages:   https://bgrins.github.io/TinyColor/   &&&   https://github.com/bgrins/TinyColor
// Lines after that (1200-1289) are my own
...
document.getElementById("convert-a-color").addEventListener("input", e => {
  ...
  newLi5.id = "newLi5"
  colorUl.appendChild(newLi).innerText = tinycolor(colorInput.value).toString();
  colorUl.appendChild(newLi2).innerText = tinycolor(colorInput.value).toString("rgb");
  colorUl.appendChild(newLi3).innerText = tinycolor(colorInput.value).toString("hsl");
  colorUl.appendChild(newLi4).innerText = tinycolor(colorInput.value).toString("hsv");
  colorUl.appendChild(newLi5).innerText = "converted-color";
  document.getElementById("newLi5").style.backgroundColor = document.getElementById("convert-a-color").value;
});
// .appendChild("li").innerText = 

document.getElementById("convert-an-exact-color-button").addEventListener("click", e => {
  colorUl.innerHTML = "";
  let newLi = document.createElement("li");
  let newLi2 = document.createElement("li");
  let newLi3 = document.createElement("li");
  ...
  let newLi5 = document.createElement("li");
  newLi5.id = "newLi5"
  colorUl.appendChild(newLi).innerText = tinycolor(exactColorInput.value).toString();
  colorUl.appendChild(newLi2).innerText = tinycolor(exactColorInput.value).toString("rgb");
  colorUl.appendChild(newLi3).innerText = tinycolor(exactColorInput.value).toString("hsl");
  colorUl.appendChild(newLi4).innerText = tinycolor(exactColorInput.value).toString("hsv");
  colorUl.appendChild(newLi5).innerText = "converted-color";
